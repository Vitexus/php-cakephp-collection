...
spl_autoload_register(function (string $class): void {
    $prefix = 'Cake\\Collection\\';
    if (str_starts_with($class, $prefix)) {
        $file = '/usr/share/php/Cake/Collection/' . str_replace('\\', '/', substr($class, strlen($prefix))) . '.php';
        if (file_exists($file)) {
            require $file;
        }
    }
...
require_once '/usr/share/php/Cake/Collection/functions.php';
